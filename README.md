...
3. First check if all external programs (autoPROC, CCP4i, ImageMagic and Adxv) are installed and in the path. (Adxv does not need to be in the path, the location of it is set in the next step.)
